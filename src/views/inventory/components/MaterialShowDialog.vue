<template>
  ...
  >
    ...
    >
      <!-- imageFiles -->
      <el-form-item :label="$t('material.id')" prop="id">
        <el-input
      ...
      <el-form-item :label="$t('material.deliveryDate')" prop="">
        <el-input
      ...
      <el-form-item :label="$t('material.creationDate')" prop="">
        <el-input
      ...
      <el-form-item :label="$t('material.lastUpdate')" prop="">
        <el-input
      ...
      <el-form-item :label="$t('material.prepaymentAmount')" prop="">
        <el-input
      ...
      <el-form-item label="上传图片文件" class="el-form-upload">
        <el-upload
          v-model:file-list="dialogProps.row!.files"
          action="#"
          :drag="true"
          :multiple="true"
...
interface DialogProps {
  title: string;
  isView: boolean;
  row: Partial<Material.Materials>;
